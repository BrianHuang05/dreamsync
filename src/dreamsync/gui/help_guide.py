...
_SECTIONS: tuple[tuple[str, str], ...] = (
    ...
    (
        ...
        <p>On Linux, Audio routing is the single place to choose the source application, route, and physical playback output. Save and restart through start_linux_dreamsync.sh to apply these settings. The resolved capture monitor is displayed as read-only status. On Windows, Playback audio applies to local playlists, saved shows, and captured-show Queue replay. Reactive audio input is a separate listening-mode setting under Reactive Technical Settings.</p>
